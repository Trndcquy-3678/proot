---
name: proot-bindings
description: Modify path binding logic, read-only enforcement, and path translation
---
...
- `is_read_only_binding()` also guards non-absolute paths
- Child processes copy parent's bindings (inheritance in `tracee.c`)
